...
- Social and Departmental interaction
  ...
  - Common is the ubiquitous method of station communication, any other method is less effective, and less readily available. With the removal of greencomms, we anticipate that other forms of communication will become more widely used (holopads, announcement consoles, and others which are often more RP-friendly) which contributes to more variable and immersive gameplay.
